...
git clone https://github.com/graviumpay/gravium
```
...
```bash
    ...
    From https://github.com/graviumpay/gravium
...
[gravium/gitian.sigs](https://github.com/graviumpay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
