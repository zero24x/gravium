...
Only requiring some minor changes is gravium.cpp.
...
Changes to gravium.cpp
----------------------
gravium.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
