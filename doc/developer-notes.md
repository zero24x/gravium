...
Gravium Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Gravium Core, where everyone uses
...
pay attention to for reviewers of Gravium Core code.

General Gravium Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Gravium Core uses tinyformat, which is type safe. Leave them out to avoid confusion
