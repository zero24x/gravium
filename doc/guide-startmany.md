...
### Send 1000 GRV to New Addresses

Send exactly 1000 GRV to each new address created above.
...
Copy the masternode private key and correspondig collateral output transaction that holds the 1000 GRV.

*Note: The masternode priviate key is **not** the same as a wallet private key. **Never** put your wallet private key in the masternode.conf file. That is almost equivalent to putting your 1000 GRV on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the gravium github repo](https://github.com/graviumpay/gravium/blob/master/doc/masternode_conf.md)
...
## Update gravium.conf on server

If you generated a new masternode private key, you will need to update the remote `gravium.conf` files.
...
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `gravium.conf` file.
...
Search your Masternodes on https://graviumninja.pl/masternodes.html
