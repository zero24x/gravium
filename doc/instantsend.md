...
This mechanism has been integrated into Bitcore-Node-Gravium which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/graviumpay/insight-api-gravium#web-socket-api](https://github.com/graviumpay/insight-api-gravium#web-socket-api)
* API: [https://github.com/graviumpay/insight-api-gravium#instantsend-transactions](https://github.com/graviumpay/insight-api-gravium#instantsend-transactions)
...
By default, the Gravium Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Gravium Core daemon:
