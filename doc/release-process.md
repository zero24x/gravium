...
* Update translations, see [translation_process.md](https://github.com/gravium/gravium/blob/master/doc/translation_process.md#syncing-with-transifex)
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/gravium/gitian.sigs.git
...
### Build and sign Gravium Core for Linux, Windows, and OS X:
	...
	./bin/gbuild --commit gravium=v${VERSION} ../gravium/contrib/gitian-descriptors/gitian-osx.yml
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [gravium-detached-sigs](https://github.com/gravium/gravium-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Update title of #gravium on Freenode IRC
