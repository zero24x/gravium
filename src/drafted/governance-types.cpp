...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GraviumNetwork") type = GraviumNetwork;
    if(strType == "GraviumNetworkVariable") type = GraviumNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GraviumNetwork) s = "GraviumNetwork";
    if(type == GraviumNetworkVariable) s = "GraviumNetworkVariable";
