...
#define BOOST_TEST_MODULE Gravium Test Suite

#include "test_gravium.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_gravium_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
