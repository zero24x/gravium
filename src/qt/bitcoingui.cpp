    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Gravium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Gravium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gravium: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Gravium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Gravium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Gravium Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Gravium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Gravium addresses"));
    ...
    openAction->setStatusTip(tr("Open a gravium: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gravium Core help message to get a list with possible Gravium Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Gravium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Gravium network", "", count));
    } else {
...
{
    QString strTitle = tr("Gravium Core"); // default title
