    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Gravium Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Gravium Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  gravium-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Gravium in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 GRV, 0.1 GRV, 1 GRV and 10 GRV -- sort of like the paper money you use every day.</li> \
...
For more info see <a style=\"color: #00D1B2;\" href=\"https://gravium.atlassian.net/wiki/display/DOC/PrivateSend\">https://gravium.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Gravium Core is shutting down...") + "<br /><br />" +
