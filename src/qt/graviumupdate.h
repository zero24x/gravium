#ifndef GRVVERSIONCHECKER_H
#define GRVVERSIONCHECKER_H

#include <QObject>

#define GRV_RELEASES "https://github.com/Gravium/gravium/releases"
...
class GraviumUpdate : public QObject
{
    Q_OBJECT
public:
    explicit GraviumUpdate(QObject *parent = 0);
    ~GraviumUpdate();
